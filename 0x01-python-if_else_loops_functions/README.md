...
Learnin control flow through using of if/else statements, working with loops and defining and calling functions while learning about scope of variables, tracebacks, and arithmetic operators.
