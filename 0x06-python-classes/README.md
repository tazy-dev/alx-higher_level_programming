...
Practicing object-oriented programming using classes and objects in Python. learning about attributes, methods, and properties as well as data abstraction, data encapsulation, decorators , method overridding and constructors
