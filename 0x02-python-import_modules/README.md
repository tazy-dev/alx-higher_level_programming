...
Learning  about importing and using functions and creating modules, using the builtin functions `dir()` and `help()`, importing and executing modules along with modules namespaces and using command line arguments within Python programs.
